...
Format nazwy lekcji: `/<moduł>\/<dział>\/\d+\. <lekcja>/`; Przykład: `Programowanie proceduralne/Funkcje/34. Argumenty opcjonalne`. (W Wattpadowej wersji nie ma liczby, ale na GitHubie pliki sortują się w kolejności alfabetycznej).
...
Następna lekcja: [2. Wstęp/O C++](https://github.com/ankiedos/Podrecznik-do-nauki-Nowoczesnego-Cpp/blob/main/MarkDown/Wst%C4%99p/0.%20O%20C%2B%2B.md)
